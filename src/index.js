...
const MAX_CONCURRENT_FFMPEG = 1; // Hard-lock for Railway stability (avoid env misconfiguration)
const FFMPEG_THREADS = 1; // Hard-lock single-thread to avoid OOM/SIGKILL on constrained instances
